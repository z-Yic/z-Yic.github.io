...
md，就算本人较菜，也不应该看文档都不会用vue-router吧；尤其是`<router-view>`必须放在`App.vue`的问题，官方文档只是简单一句`<router-view>`可以放在任意地方，这种有歧义甚至误导性的说辞，让一个菜鸟怎么去理解。

关于框架的学习和使用，优秀的框架确实可以提升开发效率，避免重复造轮子，毕竟自己造的轮子不一定比别人好！但并不意味着学好框架就行，一方面舍弃自己的思维方式去迎合框架的设计，最终会形成某种定式思维，另外使用框架的过程中遇到问题，会依赖官方来解决问题，而不是自己尝试从源码中分析原因，去优化代码；
